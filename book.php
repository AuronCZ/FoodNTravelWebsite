...
<section class="contact" id="contact">
    ...
    <form action="book_form.php" method="post" data-aos="zoom">
      ...
      <div class="inputBox">
        ...
        <input type="text" name="whereAt" id="" placeholder="where to" data-aos="fade-up">
      </div>

      <div class="inputBox">
        <input type="date" name="arriving" id="" placeholder="arriving" data-aos="fade-up">
        <input type="date" name="leaving" id="" placeholder="leaving" data-aos="fade-up">
      </div>
